...
public class ConcurrentKafkaListenerContainerFactoryConfigurer {
	...
	/**
	 * Set the {@link com.wisely.framework.plugins.mq.kafka.KafkaProperties} to use.
	...
	private void configureListenerFactory(ConcurrentKafkaListenerContainerFactory<Object, Object> factory) {
		...
		org.springframework.boot.autoconfigure.kafka.KafkaProperties.Listener properties = this.properties.getListener();
		...
		if (properties.getType().equals(org.springframework.boot.autoconfigure.kafka.KafkaProperties.Listener.Type.BATCH)) {
