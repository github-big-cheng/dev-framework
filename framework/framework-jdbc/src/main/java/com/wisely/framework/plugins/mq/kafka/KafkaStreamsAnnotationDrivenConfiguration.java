...
class KafkaStreamsAnnotationDrivenConfiguration {
	...
	KafkaStreamsAnnotationDrivenConfiguration(org.springframework.boot.autoconfigure.kafka.KafkaProperties properties) {
	...
	static class KafkaStreamsFactoryBeanConfigurer implements InitializingBean {
		...
		KafkaStreamsFactoryBeanConfigurer(org.springframework.boot.autoconfigure.kafka.KafkaProperties properties, StreamsBuilderFactoryBean factoryBean) {
			this.properties = properties;
