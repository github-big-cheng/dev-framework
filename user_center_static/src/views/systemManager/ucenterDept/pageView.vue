 ...
 * @LastEditTime: 2021-08-13 14:50:18
...
<template>
    <div class="main-content-wrap inner-maincon">
        <view-com :columnNum="`row-col2`" :viewConfigs="viewConfigs">
        </view-com>
    </div>
</template>
...
                id,
            }
            let res = await this.$http.getUcenterOrgView(params);
            if (res.code == 0) {
        ...
        initViewConfig(){
            this.viewConfigs = [
                ...
                {
                    label:"上级部门",
                    content:this.viewCon.parentValue,
                },
                {
                    label:"备注",
