...
export default {
    ...
    components: {
            ...
            render(h) {
                return (
                    <div class="page-prev-box">
                        ...
                        >
                            <i class="el-icon-aliarrow-a-left"></i>
                        </button>
                        <button
                            type="button"
                            class="btn-prev"
                        ...
                        >
                            {this.$parent.prevText ? (
                                ...
                                <i class="el-icon-aliarrow-left"></i>
                            )}
                        </button>
                    </div>
                );
        ...
        Next: {
            methods: {
                ...
                refresh() {
                    ...
                    this.$parent.userChangePageSize = false;
                }
            },
            render(h) {
                return (
                    <div class="page-next-box">
                        ...
                        >
                            {this.$parent.nextText ? (
                                ...
                                <i class="el-icon-aliarrow-right"></i>
                            )}
                        </button>
                        <button
                            type="button"
                            ...
                            on-click={this.handleChange}
                        >
                            <i class="el-icon-aliarrow-a-right"></i>
                        </button>
                        <button
                            type="button"
                            class="btn-next"
            ...
            render(h) {
                return (
                    <span class="el-pagination__jump">
                        ...
                        />
                        页，共 {this.$parent.internalPageCount} 页
                    </span>
                );
            }
        },
        ...
        Total: {
            ...
            render(h) {
                let { total, currentPage, internalPageSize } = this.$parent;
                const start = internalPageSize * (currentPage - 1) + 1;
                const end =
                internalPageSize * currentPage > total
                        ? total
                        : internalPageSize * currentPage;

                return typeof this.$parent.total === 'number' ? (
                    <span class="el-pagination__total">
                        共<i class="el-pagination__total_strange">{total}</i>
                        条，显示第 {start} ~ {end} 条
                    </span>
                ) : (
                    ''
