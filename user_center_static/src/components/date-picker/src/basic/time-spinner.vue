...
export default {
    ...
    computed: {
        ...
        minutes() {
            ...
            if (minutes % 15 !== 0) {
                minutes -= minutes % 15;
                this.modifyDateField('minutes', minutes / 15);
            }
            return minutes;
        },
        seconds() {
    ...
    methods: {
        ...
        adjustSpinner(type, value) {
            ...
            if (el) {
                const v =
                    type !== 'minutes' ? value : value > 4 ? value / 15 : value;
                el.scrollTop = Math.max(0, v * this.typeItemHeight(type));
            }
        },
