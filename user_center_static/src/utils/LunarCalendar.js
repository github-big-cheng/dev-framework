...
(function() {
    ...
    function getLunarDateByBetween(year, between) {
        ...
        var end =
            between > 0 ? between : lunarYearDays.yearDays - Math.abs(between);
    ...
    function solarToLunar(_year, _month, _day) {
        ...
        var GanZhiYear =
            month > 1 || (month == 1 && day >= term2) ? year + 1 : year; //干支所在年份
        ...
        if (
            ...
            lunarFtv =
                lunarFestival[formateDayD4(lunarDate[1] - 1, lunarDate[2])];
        } else {
        ...
        var res = {
            ...
            worktime:
                worktime['y' + year] &&
                worktime['y' + year][formateDayD4(month, day)]
                    ? worktime['y' + year][formateDayD4(month, day)]
                    : 0,
